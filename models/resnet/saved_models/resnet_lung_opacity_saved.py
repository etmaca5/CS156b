...
model_save_path = os.path.join(output_dir, 'resnet152_lung_opacity_model.pth')
...
output_file_path = os.path.join(output_dir, 'predictions_resnet152_lung_opacity.csv')
