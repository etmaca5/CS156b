...
pathology = 'Fracture'
using_hpc = 1
model_path = '/groups/CS156b/2024/butters/resnet152_fracture_model.pth'
...
output_file_path = os.path.join(output_dir, 'predictions_solution_resnet152_fracture.csv')
